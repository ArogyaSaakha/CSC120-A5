...
class Scarecrow {
     ...
     */
    public Scarecrow(Pumpkin h, Shirt b, Pants  l, Boot rf, Boot lf, Banner s) {
        head = h;
        body = b;
        legs = l;
        leftFoot = lf;
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        Scarecrow myScarecrow = new Scarecrow(new Pumpkin(), new Shirt(), new Pants(), new Boot("right"), new Boot("left"), new Banner(null));
